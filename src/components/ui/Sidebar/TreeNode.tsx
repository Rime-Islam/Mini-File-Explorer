  ...
  const rowContent = (
    <div
      className={cn(
        ...
        isActive &&
          "bg-white/70 shadow-sm border border-amber-200/50 font-medium",
        isSelected &&
          !isActive &&
          "bg-white/40 shadow-[0_0_0_1px_rgba(0,0,0,0.04)]",
      )}
      style={{ paddingLeft }}
      ...
      <span className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-0.5">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              <Trash2
                className="w-3 h-3 text-slate-500 hover:text-red-600"
                strokeWidth={2.5}
              />
            </button>
          </TooltipTrigger>
